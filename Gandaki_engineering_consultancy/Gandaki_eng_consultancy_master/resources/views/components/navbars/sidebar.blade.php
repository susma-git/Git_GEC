...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">Gandaki_eng_consultancy</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link text-white {{ $activePage == 'about' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('getAboutManage') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">About</i>
                    </div>
                    <span class="nav-link-text ms-1">About</span>
                </a>
                <a class="nav-link text-white {{ $activePage == 'service' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('getServiceManage') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <a class="nav-link text-white {{ $activePage == 'dashboard' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('getGalleryManage') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">Gallery</i>
                    </div>
